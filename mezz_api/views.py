...
from .serializers import UserSerializer, CategorySerializer, PageSerializer, SiteSerializer, CommentSerializer
...
# I think im going to swap this out for django-contrib-comments
...
#                       viewsets.GenericViewSet):
#     """
#     For listing, retrieving, creating or updating comments.
#     ---
#     list:
#         parameters:
#             - name: search
...
#     permission_classes = [IsAdminOrReadOnly]  # IsAppAuthenticated
#     filter_backends = (filters.OrderingFilter, filters.SearchFilter,)
#     ordering_fields = ('id', 'user', 'user_name', 'comment', 'submit_date', 'is_public', 'is_removed')
